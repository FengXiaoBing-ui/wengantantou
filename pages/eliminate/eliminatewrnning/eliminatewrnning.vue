<template>
	<view class="index">
		...
		<view class="wrap">
			<view class="list" v-for="(item, index) in warninglist" :key="index" @click="jump">
	...
	export default {
		...
		methods:{
			...
			jump(){
				if(this.active=='未处理'){
					uni.navigateTo({
						url:"../eliminatewrningdetail/eliminatewrningdetail"
					})
				}else{
					uni.navigateTo({
						url:"../eliminatewrningdetailtwo/eliminatewrningdetailtwo"
					})
				}
			},
			option(v){
